...
import VolumeLevel from 'video-react/lib/components/volume-control/VolumeLevel';
...
class VolumeBar extends Component {
  ...
  handleFocus(e) {
    if (this.props.onFocus && !this.props.disable) {
      this.props.onFocus(e);
    }
  }

  handleBlur(e) {
    if (this.props.onBlur && !this.props.disable) {
      this.props.onBlur(e);
    }
  }
  ...
  render() {
    const { player, className, disable } = this.props;
