...
import LoadProgressBar from 'video-react/lib/components/control-bar/LoadProgressBar';
import MouseTimeDisplay from 'video-react/lib/components/control-bar/MouseTimeDisplay';
...
export default class SeekBar extends Component {
  ...
  handleMouseUp(event) {
    const { actions, disable } = this.props;
    if (disable) {
      return;
    }
  ...
  render() {
    ...
    return (
      <Slider
        ...
        className={classNames('video-react-progress-holder', { 'control-disabled': disable }, this.props.className)}
      ...
      >
        <LoadProgressBar buffered={buffered} currentTime={time} duration={duration} />
